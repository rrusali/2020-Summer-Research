...
i = float(0.01)
final = 0.5
targets = np.arange(1295, 3005, 5).tolist()
...
for target in targets:
    ...
    save_dir = 'C:/Users/novar/Downloads/Research Stuff/Jupyter Notebooks/Data Exports/Microsoft Ranges/'
    file_name = 'Microsoft_export_all_' + str(target) + '.csv'
